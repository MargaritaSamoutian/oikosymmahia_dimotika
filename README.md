...
Για την υλοποίηση των δράσεων η πλειοψηφία των σχολείων αξιοποίησε το υλικό που διέθετε, όπως τάμπλετ, διαδραστικοί πίνακες, ρομποτικός (S1, Tpbot, Lego) και ερευνητικός εξοπλισμός. Στο σημείο αυτό είναι σημαντικό να αναφερθεί ότι το 20ο Δημοτικό Σχολείο Λαμίας και το Δημοτικό Σχολείο Δεσφίνας αξιοποίησαν τα ρομπότ που έλαβαν στο πλαίσιο του διαγωνισμού (Beebot & Ozobot).
...
Τα έξι σχέδια ανέδειξαν τη σημασία του ενεργού ρόλου των μαθητών, αλλά και ολόκληρης της σχολικής κοινότητας, σε δράσεις που εστιάζουν στη δημιουργία προσβάσιμων και λειτουργικών χώρων με σεβασμό στην ιδιωτικότητα, συμβάλλοντας στη βελτίωση της τοπικής κοινωνίας μέσω της αξιοποίησης της τεχνολογίας και καινοτόμων προσεγγίσεων. Οι ερευνητικές διαδικασίες, οι επιτόπιες επισκέψεις και η ομαδική εργασία με ανάληψη ρόλων, βοήθησαν τους μαθητές να αναπτύξουν δεξιότητες όπως η δημιουργικότητα, η επίλυση προβλημάτων, η υπευθυνότητα, καθώς και η περιβαλλοντική και κοινωνική ευαισθητοποίηση. Αξιοποίησαν ποικίλα ψηφιακά εργαλεία και τεχνολογίες, ενισχύοντας ταυτόχρονα τη σύνδεσή τους με το φυσικό και πολιτιστικό περιβάλλον. Τα έργα συνέβαλαν στην ενδυνάμωση της φωνής των μαθητών και στη διαμόρφωση μιας συμμετοχικής κουλτούρας που προάγει την ενεργή πολιτειότητα.


# Συμπεράσματα:

**Ενεργή συμμετοχή των μαθητών:** Όλα τα σχέδια έδωσαν έμφαση στη βιωματική μάθηση, την ερευνητική προσέγγιση και την ενδυνάμωση των μαθητών ως δημιουργών.

**Διαθεματικότητα και καινοτομία:** Καλλιεργήθηκαν γνώσεις και αποκτήθηκαν εμπειρίες από διαφορετικά γνωστικά πεδία (STEM, περιβαλλοντική εκπαίδευση, κοινωνικές επιστήμες, τεχνολογία).

**Τεχνολογικά εργαλεία:** Αξιοποιήθηκαν ψηφιακά εργαλεία, ρομποτικά κιτ και κινητές συσκευές (QR codes, εκπαιδευτική ρομποτική, tablets, ανοιχτά λογισμικά) για την ενίσχυση της διαδραστικότητας και την ανανέωση της εκπαιδευτικής διαδικασίας.

**Διασύνδεση με την κοινότητα:** Όλα τα έργα εμπλέκουν άμεσα την τοπική κοινωνία είτε ως αποδέκτη, είτε ως ενεργό συμμετέχοντα (επισκέψεις, παρουσιάσεις, παρεμβάσεις).

**Καλλιέργεια κοινωνικής ευθύνης και περιβαλλοντικής συνείδησης:** Οι μαθητές έμαθαν να παρεμβαίνουν με σεβασμό στο δημόσιο χώρο και να αναπτύσσουν κριτική σκέψη.

**Προώθηση καλών πρακτικών και βιωσιμότητα:** Τα περισσότερα σχέδια συνοδεύονται από αξιολόγηση και διάχυση αποτελεσμάτων.
